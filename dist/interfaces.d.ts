...
export type FortnoxScope = 'salary' | 'bookkeeping' | 'archive' | 'connectfile' | 'article' | 'companyinformation' | 'settings' | 'invoice' | 'costcenter' | 'currency' | 'customer' | 'inbox' | 'payment' | 'noxfinansinvoice' | 'offer' | 'order' | 'price' | 'project' | 'profile' | 'supplier' | 'supplierinvoice';
