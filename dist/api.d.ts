...
export interface Employee {
    ...
    ScheduleId?: string;
    ForaType?: "A" | "A51" | "A52" | "A53" | "A54" | "A55" | "A56" | "A57" | "A58" | "A59" | "A60" | "A61" | "A62" | "A63" | "A64" | "A65" | "A66" | "A67" | "A68" | "A69" | "A70" | "A71" | "A72" | "A73" | "A74" | "A75" | "A76" | "A77" | "A78" | "A79" | "A80" | "A81" | "A82" | "A83" | "A84" | "A85" | "A86" | "A3" | "A91" | "A92" | "A93" | "A11" | "A12" | "A13" | "A14" | "A15" | "A16" | "A17" | "A18" | "A19" | "A20" | "A21" | "A22" | "A23" | "A24" | "A25" | "A26" | "A27" | "A28" | "A29" | "A30" | "A41" | "A42" | "A43" | "A44" | "A45" | "A46" | "A47" | "A48" | "T" | "T6" | "-";
...
export interface OfferOfferRow {
    ...
    HouseWorkType?: "CONSTRUCTION" | "ELECTRICITY" | "GLASSMETALWORK" | "GROUNDDRAINAGEWORK" | "MASONRY" | "PAINTINGWALLPAPERING" | "HVAC" | "CLEANING" | "TEXTILECLOTHING" | "COOKING" | "SNOWPLOWING" | "GARDENING" | "BABYSITTING" | "OTHERCARE" | "TUTORING" | "OTHERCOSTS";
    /** @format double */
    Price?: number;
    Project?: string;
    Quantity?: string;
...
export interface ResponseStateChange {
    responseState?: "NOT_SENT" | "SENT" | "ACCEPTED_WITH_REQ_DLV_DATE" | "ACCEPTED_WITH_CHANGED_DLV_DATE" | "PARTLY_ACCEPTED_WITH_REQ_DLV_DATE" | "PARTLY_ACCEPTED_WITH_CHANGED_DLV_DATE" | "REJECTED";
}
...
export interface InvoiceAccrual {
    ...
    /** @format int32 */
    InvoiceNumber: number;
    Period?: "MONTHLY" | "BIMONTHLY" | "QUARTERLY" | "SEMIANNUALLY" | "ANNUALLY" | "1_MONTHS" | "2_MONTHS" | "3_MONTHS" | "6_MONTHS" | "12_MONTHS";
    /**
     * @format int32
     * @min 1000
     * @max 9999
...
export interface OrderOrderRow {
    ...
    /** @format int32 */
    HouseWorkHoursToReport?: number;
    HouseWorkType?: "CONSTRUCTION" | "ELECTRICITY" | "GLASSMETALWORK" | "GROUNDDRAINAGEWORK" | "MASONRY" | "PAINTINGWALLPAPERING" | "MOVINGSERVICES" | "ITSERVICES" | "CLEANING" | "TEXTILECLOTHING" | "SNOWPLOWING" | "GARDENING" | "BABYSITTING" | "OTHERCARE" | "OTHERCOSTS";
...
export interface PurchaseOrder {
    ...
    voided?: boolean;
    responseState?: "NOT_SENT" | "SENT" | "ACCEPTED_WITH_REQ_DLV_DATE" | "ACCEPTED_WITH_CHANGED_DLV_DATE" | "PARTLY_ACCEPTED_WITH_REQ_DLV_DATE" | "PARTLY_ACCEPTED_WITH_CHANGED_DLV_DATE" | "REJECTED";
    purchaseOrderState?: "NOT_SENT" | "SENT" | "SENT_NOT_REJECTED" | "DELAYED" | "RECEIVED" | "VOIDED" | "CURRENT" | "ALL";
    /**
     * @minLength 0
     * @maxLength 100
     */
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    warehouse: {
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<StockPoint, any>>;
        /**
         ...
         */
        create: (stockPoint: StockPoint, params?: RequestParams) => Promise<AxiosResponse<StockPoint, any>>;
        /**
         ...
         */
        getStockLocationsByAmbiguousId: (id: string, query?: {
            /** filters on stock location code or name. */
            q?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<StockLocation, any>>;
        /**
         ...
         */
        getByAmbiguousId: (id: string, params?: RequestParams) => Promise<AxiosResponse<StockPoint, any>>;
        /**
         ...
         */
        appendStockLocations: (id: string, stockLocations: StockLocation[], params?: RequestParams) => Promise<AxiosResponse<StockLocation, any>>;
        /**
         ...
         */
        update: (id: string, stockPoint: StockPoint, params?: RequestParams) => Promise<AxiosResponse<StockPoint, any>>;
        /**
         ...
         */
        delete: (id: string, params?: RequestParams) => Promise<AxiosResponse<StockPoint, any>>;
        /**
         * No description
         *
         ...
         */
        get: (id: number, params?: RequestParams) => Promise<AxiosResponse<StockTransferDocument, any>>;
        /**
         * No description
         *
         * @tags StockTransferResource
         ...
         * @response `200` `StockTransferDocument` The <code>StockTransferDocument</code> document.
         */
        updateStockTransferResource: (id: number, document: StockTransferDocument, params?: RequestParams) => Promise<AxiosResponse<StockTransferDocument, any>>;
        /**
         ...
         * @response `200` `StockTransferDocument` The <code>StockTransferDocument</code> document.
         */
        createStockTransferResource: (document: StockTransferDocument, params?: RequestParams) => Promise<AxiosResponse<StockTransferDocument, any>>;
        /**
         ...
         */
        release: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        voidStockTransfer: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        getTenant: (params?: RequestParams) => Promise<AxiosResponse<TenantInfo, any>>;
        /**
         * No description
         *
         ...
         */
        getAllManualDocumentResource: (query?: {
            ...
            itemId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ManualDocument, any>>;
        /**
         ...
         */
        createManualInboundDocumentResource: (manualInboundDocument: ManualInboundDocument, params?: RequestParams) => Promise<AxiosResponse<ManualInboundDocument, any>>;
        /**
         * No description
         *
         * @tags ManualInboundDocumentResource
         ...
         * @response `200` `ManualInboundDocument` the <code>ManualInboundDocument</code> document.
         */
        getManualInboundDocumentResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<ManualInboundDocument, any>>;
        /**
         * No description
         *
         * @tags ManualInboundDocumentResource
         ...
         * @response `200` `ManualInboundDocument` the <code>ManualInboundDocument</code> document.
         */
        updateManualInboundDocumentResource: (id: number, manualInboundDocument: ManualInboundDocument, params?: RequestParams) => Promise<AxiosResponse<ManualInboundDocument, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        updateNote: (id: number, manualInboundDocumentPatch: ManualInboundDocumentPatch, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        releaseManualInboundDocumentResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        createManualOutboundDocumentResource: (manualOutboundDocument: ManualOutboundDocument, params?: RequestParams) => Promise<AxiosResponse<ManualOutboundDocument, any>>;
        /**
         * No description
         *
         * @tags ManualOutboundDocumentResource
         ...
         * @response `200` `ManualOutboundDocument` the <code>ManualOutboundDocument</code> document.
         */
        getManualOutboundDocumentResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<ManualOutboundDocument, any>>;
        /**
         ...
         * @response `200` `ManualOutboundDocument` the <code>ManualOutboundDocument</code> document.
         */
        updateManualOutboundDocumentResource: (id: number, manualOutboundDocument: ManualOutboundDocument, params?: RequestParams) => Promise<AxiosResponse<ManualOutboundDocument, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        updateNoteManualOutboundDocumentResource: (id: number, manualOutboundDocumentPatch: ManualOutboundDocumentPatch, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags ManualOutboundDocumentResource
         ...
         * @response `default` `void` Nothing.
         */
        voidDocumentManualOutboundDocumentResource: (id: number, query?: {
            /**
         ...
         * @response `default` `void` Nothing.
         */
        releaseManualOutboundDocumentResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         ...
         */
        getAllCustomDocumentTypeResource: (params?: RequestParams) => Promise<AxiosResponse<CustomDocumentType, any>>;
        /**
         ...
         */
        createCustomDocumentTypeResource: (customDocumentType: CustomDocumentType, params?: RequestParams) => Promise<AxiosResponse<number, any>>;
        /**
         * No description
         *
         * @tags CustomDocumentTypeResource
         ...
         */
        getCustomDocumentTypeResource: (type: string, params?: RequestParams) => Promise<AxiosResponse<CustomDocumentType, any>>;
        /**
         * No description
         *
         ...
         */
        getCustomInboundDocumentResource: (type: string, id: string, params?: RequestParams) => Promise<AxiosResponse<CustomInboundDocument, any>>;
        /**
         * No description
         *
         * @tags CustomInboundDocumentResource
         ...
         */
        save: (type: string, id: string, document: CustomInboundDocument, params?: RequestParams) => Promise<AxiosResponse<CustomInboundDocument, any>>;
        /**
         ...
         */
        releaseCustomInboundDocumentResource: (type: string, id: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` no content
         */
        voidDocumentCustomInboundDocumentResource: (type: string, id: string, query?: {
         ...
         */
        getCustomOutboundDocumentResource: (type: string, id: string, params?: RequestParams) => Promise<AxiosResponse<CustomOutboundDocument, any>>;
        /**
         ...
         */
        saveCustomOutboundDocumentResource: (type: string, id: string, document: CustomOutboundDocument, params?: RequestParams) => Promise<AxiosResponse<CustomOutboundDocument, any>>;
        /**
         * No description
         *
         * @tags CustomOutboundDocumentResource
         ...
         * @response `default` `void` no content
         */
        releaseCustomOutboundDocumentResource: (type: string, id: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags CustomOutboundDocumentResource
         ...
         * @response `default` `void` no content
         */
        voidDocumentCustomOutboundDocumentResource: (type: string, id: string, query?: {
            /** true if the document should be voided even if the document has connected outbounds, defaults to false. */
            force?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        getAllProductionOrderResource: (query?: {
            /**
            ...
            itemId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ProductionOrder, any>>;
        /**
         ...
         */
        createProductionOrderResource: (productionOrder: ProductionOrder, params?: RequestParams) => Promise<AxiosResponse<ProductionOrder, any>>;
        /**
         * No description
         *
         * @tags ProductionOrderResource
         ...
         * @response `200` `ProductionOrder` the <code>ProductionOrder</code> document.
         */
        getProductionOrderResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<ProductionOrder, any>>;
        /**
         ...
         * @response `200` `ProductionOrder` the <code>ProductionOrder</code> document.
         */
        updateProductionOrderResource: (id: number, productionOrder: ProductionOrder, params?: RequestParams) => Promise<AxiosResponse<ProductionOrder, any>>;
        /**
         ...
         * @response `200` `ProductionOrder` the <code>ProductionOrder</code> document.
         */
        updateNoteProductionOrderResource: (id: number, productionOrderPatch: ProductionOrderPatch, params?: RequestParams) => Promise<AxiosResponse<ProductionOrder, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        voidProductionOrder: (id: number, query?: {
         ...
         * @response `200` `ProductionOrder` the <code>ProductionOrder</code> document.
         */
        releaseProductionOrderResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<ProductionOrder, any>>;
        /**
         ...
         */
        getRequiredProductionParts: (itemId: string, query?: {
            /**
            ...
            quantity?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<PackageItem, any>>;
        /**
         * No description
         *
         ...
         */
        saveIncomingGoodsResource: (id: number, incomingGoods: IncomingGoods, params?: RequestParams) => Promise<AxiosResponse<IncomingGoods, any>>;
        /**
         ...
         * @response `200` `IncomingGoods` The updated <code>IncomingGoods</code> document.
         */
        patch: (id: number, incomingGoods: IncomingGoods, params?: RequestParams) => Promise<AxiosResponse<IncomingGoods, any>>;
        /**
         ...
         */
        getAllIncomingGoodsResource: (query?: {
            /**
            ...
            q?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<IncomingGoodsListRow[], any>>;
        /**
         * No description
         *
         * @tags IncomingGoodsResource
         ...
         */
        createIncomingGoodsResource: (incomingGoods: IncomingGoods, params?: RequestParams) => Promise<AxiosResponse<IncomingGoods, any>>;
        /**
         * @description The document will be locked and bookkept. The inbound deliveries will affect available stock.
         *
         * @tags IncomingGoodsResource
         ...
         * @response `default` `void` Nothing.
         */
        releaseIncomingGoodsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        completed: (id: number, bookingDate: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        voidDocumentIncomingGoodsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        getAllPurchaseOrderResource: (query?: {
            ...
            /** Include only documents where `note`-field contains the given text (case-insensitive). */
            note?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<PurchaseOrder, any>>;
        /**
         * No description
         *
         * @tags PurchaseOrderResource
         ...
         */
        createPurchaseOrderResource: (purchaseOrder: PurchaseOrder, params?: RequestParams) => Promise<AxiosResponse<PurchaseOrder, any>>;
        /**
         * No description
         *
         * @tags PurchaseOrderResource
         ...
         */
        updateResponseState: (id: number, responseStateChange: ResponseStateChange, params?: RequestParams) => Promise<AxiosResponse<PurchaseOrder, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        setManuallyCompleted: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        setDropshipManuallyCompleted: (id: number, params?: RequestParams) => Promise<AxiosResponse<ReleaseParentOrder, any>>;
        /**
         * No description
         *
         * @tags PurchaseOrderResource
         ...
         */
        batchUpdateResponseState: (responseStateChange: ResponseStateChange, query?: {
         ...
         */
        getPurchaseOrderResource: (id: number, query?: {
            /**
         ...
         * @response `200` `PurchaseOrder` The updated <code>PurchaseOrder</code>.
         */
        updatePurchaseOrderResource: (id: number, purchaseOrder: PurchaseOrder, params?: RequestParams) => Promise<AxiosResponse<PurchaseOrder, any>>;
        /**
         ...
         */
        updatePartial: (id: number, changes: PartialPurchaseOrder, params?: RequestParams) => Promise<AxiosResponse<PartialPurchaseOrder, any>>;
        /**
         ...
         */
        sendPurchaseOrder: (id: number, settings: PurchaseOrderMailSettings, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags PurchaseOrderResource
         ...
         * @response `default` `void` Nothing.
         */
        sendPurchaseOrders: (purchaseOrderIds: number[], params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags PurchaseOrderResource
         ...
         * @response `default` `void` Nothing.
         */
        voidDocumentPurchaseOrderResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        getMatchedDocuments: (id: number, params?: RequestParams) => Promise<AxiosResponse<DocumentReference, any>>;
        /**
         ...
         */
        getAttachedNotes: (id: number, params?: RequestParams) => Promise<AxiosResponse<PurchaseOrderRowNote, any>>;
        /**
         ...
         */
        getAllStockTakingResource: (query?: {
            ...
            itemId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<StockTaking, any>>;
        /**
         ...
         */
        createStockTakingResource: (stockTaking: StockTaking, params?: RequestParams) => Promise<AxiosResponse<StockTaking, any>>;
        /**
         * No description
         *
         * @tags StockTakingResource
         ...
         */
        getStockTakingResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<StockTaking, any>>;
        /**
         ...
         * @response `200` `StockTaking` The <code>StockTaking</code> document.
         */
        updateStockTakingResource: (id: number, stockTaking: StockTaking, params?: RequestParams) => Promise<AxiosResponse<StockTaking, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        deleteStockTaking: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        releaseStockTakingResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `default` `void` Nothing.
         */
        voidStockTaking: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        getCandidateRows: (id: number, query?: {
            itemIds?: string[];
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<StockTakingRow, any>>;
        /**
         * No description
         *
         * @tags StockTakingResource
         ...
         * @response `default` `void` Nothing.
         */
        addStockTakingRows: (id: number, rows: StockTakingRow[], params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        deleteStockTakingRowByFilter: (id: number, query?: {
            itemIds?: string[];
            supplierNumbers?: string[];
            stockPointIds?: string[];
            stockLocationIds?: string[];
            ...
            itemDescriptionSearch?: string;
            excludeZeroBalanceItems?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<number, any>>;
        /**
         ...
         */
        addStockTakingRowsByFilter: (id: number, query?: {
            itemIds?: string[];
            supplierNumbers?: string[];
            stockPointIds?: string[];
            stockLocationIds?: string[];
         ...
         */
        deleteStockTakingRow: (id: number, rowId: string, params?: RequestParams) => Promise<AxiosResponse<number, any>>;
    };
    time: {
        /**
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<BaseArticleRegistration[], any>>;
        /**
         ...
         */
        listRegistrationsResource: (query?: {
            /**
             * The start date of the search span, the max of which should be 1 year to the end date ("toDate").
             *  Example: 2022-11-01
             * @format date
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<DetailedRegistration[], any>>;
    };
    absencetransactions: {
        /**
         ...
         */
        listAbsenceTransactionsResource: (query?: {
            /** filter by employee id */
            employeeid?: string;
            /** filter by date */
            date?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<AbsenceTransactionListItemWrap, any>>;
        /**
         * No description
         *
         * @tags AbsenceTransactionsResource
         ...
         */
        createAbsenceTransactionsResource: (absenceTransactionsPayload: AbsenceTransactionPayloadWrap, params?: RequestParams) => Promise<AxiosResponse<AbsenceTransactionSingleItemWrap, any>>;
        /**
         ...
         */
        getAbsenceTransactionsResource: (id: string, params?: RequestParams) => Promise<AxiosResponse<AbsenceTransactionSingleItemWrap, any>>;
        /**
         * No description
         *
         * @tags AbsenceTransactionsResource
         ...
         */
        updateAbsenceTransactionsResource: (id: string, absenceTransactionsPayload: AbsenceTransactionPayloadWrap, params?: RequestParams) => Promise<AxiosResponse<AbsenceTransactionSingleItemWrap, any>>;
        /**
         * No description
         *
         * @tags AbsenceTransactionsResource
         ...
         */
        remove: (id: string, params?: RequestParams) => Promise<AxiosResponse<AbsenceTransactionSingleItemWrap, any>>;
        /**
         ...
         * @response `200` `AbsenceTransactionListItemWrap` a list of absence transactions
         */
        getAbsenceTransactionsResource1: (employeeId: string, date: string, code: "ASK" | "FPE" | "FRA" | "HAV" | "KOM" | "MIL" | "NAR" | "OS1" | "OS2" | "OS3" | "OS4" | "OS5" | "PAP" | "PEM" | "PER" | "SEM" | "SJK" | "SMB" | "SVE" | "TJL" | "UTB" | "VAB", params?: RequestParams) => Promise<AxiosResponse<AbsenceTransactionListItemWrap, any>>;
    };
    accountcharts: {
        /**
         ...
         */
        listAccountChartsResource: (params?: RequestParams) => Promise<AxiosResponse<AccountChartWrap, any>>;
    };
    accounts: {
        /**
         ...
         */
        getAccountsResource: (number: number, params?: RequestParams) => Promise<AxiosResponse<AccountSingleItemWrap, any>>;
        /**
         ...
         */
        updateAccountsResource: (number: number, accountPayload: AccountPayloadWrap, query?: {
            /**
             * financial year to update account against
             * @format int32
             */
            financialyear?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<AccountSingleItemWrap, any>>;
        /**
         ...
         */
        listAccountsResource: (query?: {
            lastmodified?: string;
            /** @format int32 */
            sru?: number;
            /** field to sort returned list on */
            sortby?: "number";
        }, params?: RequestParams) => Promise<AxiosResponse<AccountListItemWrap, any>>;
        /**
         ...
         */
        createAccountsResource: (accountPayload: AccountPayloadWrap, query?: {
            /**
    ...
    archive: {
        ...
        getFolder: (query?: {
            ...
            fileid?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<FolderWrap, any>>;
        /**
        ...
        uploadFile: (data: {
            ...
            /** id of folder */
            folderid?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<FolderFileRowWrap, any>>;
        /**
         ...
         * @response `default` `void` empty
         */
        removeById: (id: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    articlefileconnections: {
         ...
         */
        listArticleFileConnectionsResource: (params?: RequestParams) => Promise<AxiosResponse<ArticleFileConnectionListItemWrap, any>>;
        /**
         * No description
         *
         * @tags ArticleFileConnectionsResource
         ...
         */
        createArticleFileConnectionsResource: (articleFileConnection: ArticleFileConnectionWrap, params?: RequestParams) => Promise<AxiosResponse<ArticleFileConnectionWrap, any>>;
        /**
         * No description
         *
         * @tags ArticleFileConnectionsResource
         ...
         */
        getArticleFileConnectionsResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<ArticleFileConnectionWrap, any>>;
        /**
         * No description
         *
         * @tags ArticleFileConnectionsResource
         ...
         * @response `default` `void` empty
         */
        removeArticleFileConnectionsResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    articles: {
        /**
         ...
         */
        updateArticlesResourceArticles: (articleNumber: number, article: ArticleWrap, params?: RequestParams) => Promise<AxiosResponse<ArticleWrap, any>>;
        /**
         ...
         * @response `default` `void` empty
         */
        removeArticlesResourceArticles: (articleNumber: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        listArticlesResourceArticles: (query?: {
            ...
            /** filter by page */
            page?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<ArticleListItemList, any>>;
        /**
         ...
         */
        createArticlesResourceArticles: (article: ArticleWrap, params?: RequestParams) => Promise<AxiosResponse<ArticleWrap, any>>;
    };
    assetfileconnections: {
         ...
         */
        getAllAssetFileConnectionResource: (params?: RequestParams) => Promise<AxiosResponse<AssetFileConnectionResponse, any>>;
        /**
         * No description
         *
         * @tags AssetFileConnectionResource
         ...
         */
        createAssetFileConnectionResource: (assetFileConnection: CreateAssetFileConnection, params?: RequestParams) => Promise<AxiosResponse<AssetFileConnection, any>>;
        /**
         * No description
         *
         * @tags AssetFileConnectionResource
         ...
         * @response `default` `void` empty
         */
        deleteAssetFileConnectionResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    assets: {
        /**
         * No description
         ...
         */
        listAssetsResource: (params?: RequestParams) => Promise<AxiosResponse<ListAssetWrap, any>>;
        /**
         ...
         */
        createAssetsResource: (asset: CreateAssetWrap, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         * No description
         *
         * @tags AssetsResource
         ...
         * @response `200` `AssetSingle` asset
         */
        getAssetsResource: (givenNumber: string, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         ...
         * @response `200` `AssetSingle` asset
         */
        changeManualObValue: (givenNumber: string, asset: ManualObAsset, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         ...
         */
        deleteAssetsResource: (givenNumber: string, request: DeleteWrap, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         * @response `200` `ListAssetWrap` list of assets
         */
        getDeprecationList: (toDate: string, params?: RequestParams) => Promise<AxiosResponse<ListAssetWrap, any>>;
        /**
         * @description The updated asset will be returned if everything succeeded, if there was any problems an error will be returned.
         *
         * @tags AssetsResource
         ...
         * @response `200` `AssetSingle` asset
         */
        writeUp: (givenNumber: string, asset: WriteUpWrap, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         * @description The updated asset will be returned if everything succeeded, if there was any problems an error will be returned.
         *
         * @tags AssetsResource
         ...
         * @response `200` `AssetSingle` asset
         */
        writeDown: (givenNumber: string, asset: WriteDownWrap, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         * @description The updated asset will be returned if everything succeeded, if there was any problems an error will be returned.
         *
         * @tags AssetsResource
         ...
         * @response `200` `AssetSingle` asset
         */
        scrap: (givenNumber: string, asset: ScrapWrap, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         ...
         * @response `200` `AssetSingle` asset
         */
        sell: (givenNumber: string, asset: SellWrap, params?: RequestParams) => Promise<AxiosResponse<AssetSingle, any>>;
        /**
         ...
         */
        depreciate: (body: DepreciationWrap, params?: RequestParams) => Promise<AxiosResponse<DepreciationResponseWrap, any>>;
        /**
         * No description
         *
         ...
         */
        getAssetTypesResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<AssetTypeWrapSingle, any>>;
        /**
         * No description
         *
         * @tags AssetTypesResource
         ...
         */
        createAssetTypesResource: (id: number, createAssetRequest: CreateAssetWrap, params?: RequestParams) => Promise<AxiosResponse<AssetTypeWrapSingle, any>>;
        /**
         * No description
         *
         * @tags AssetTypesResource
         ...
         * @response `200` `AssetTypeWrapSingle` response
         */
        updateAssetTypesResource: (id: number, updateAssetRequest: UpdateAssetWrap, params?: RequestParams) => Promise<AxiosResponse<AssetTypeWrapSingle, any>>;
        /**
         * No description
         *
         * @tags AssetTypesResource
         ...
         * @response `default` `void` empty
         */
        deleteAssetTypesResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags AssetTypesResource
         ...
         */
        getAllAssetTypesResource: (params?: RequestParams) => Promise<AxiosResponse<AssetTypeWrapList, any>>;
    };
    attendancetransactions: {
         ...
         */
        listAttendanceTransactionsResource: (query?: {
            /** filter by employee id */
            employeeid?: string;
            /** filter by date */
            date?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<AttendanceTransactionListItemList, any>>;
        /**
         * No description
         *
         * @tags AttendanceTransactionsResource
         ...
         */
        createAttendanceTransactionsResource: (attendanceTransaction: AttendanceTransactionWrap, params?: RequestParams) => Promise<AxiosResponse<AttendanceTransactionWrap, any>>;
        /**
         * @description Retrieves a specific transaction
         *
         * @tags AttendanceTransactionsResource
         ...
         */
        getAttendanceTransactionsResource: (id: string, params?: RequestParams) => Promise<AxiosResponse<AttendanceTransactionWrap, any>>;
        /**
         * No description
         *
         * @tags AttendanceTransactionsResource
         ...
         */
        updateAttendanceTransactionsResource: (id: string, attendanceTransaction: AttendanceTransactionWrap, params?: RequestParams) => Promise<AxiosResponse<AttendanceTransactionWrap, any>>;
    };
    companyinformation: {
        /**
         * No description
         ...
         */
        getCompanyInformationResource: (params?: RequestParams) => Promise<AxiosResponse<CompanyInfoWrap, any>>;
    };
    settings: {
        /**
         * No description
         ...
         */
        getCompanySettingsResource: (params?: RequestParams) => Promise<AxiosResponse<CompanySettingsWrap, any>>;
        /**
         ...
         */
        getLockedPeriodResource: (params?: RequestParams) => Promise<AxiosResponse<LockedPeriodWrap, any>>;
    };
    contractaccruals: {
        /**
         ...
         */
        listContractAccrualsResource: (params?: RequestParams) => Promise<AxiosResponse<ContractAccrualListItemList, any>>;
        /**
         * No description
         *
         * @tags ContractAccrualsResource
         ...
         */
        createContractAccrualsResource: (contractAccrual: ContractAccrualWrap, params?: RequestParams) => Promise<AxiosResponse<ContractAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags ContractAccrualsResource
         ...
         */
        getContractAccrualsResource: (documentNumber: number, params?: RequestParams) => Promise<AxiosResponse<ContractAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags ContractAccrualsResource
         ...
         */
        updateContractAccrualsResource: (documentNumber: number, contractAccrual: ContractAccrualWrap, params?: RequestParams) => Promise<AxiosResponse<ContractAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags ContractAccrualsResource
         ...
         * @response `default` `void` empty
         */
        removeContractAccrualsResource: (documentNumber: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    contracts: {
        /**
         * No description
         ...
         */
        getContractsResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<ContractWrap, any>>;
        /**
         ...
         */
        updateContractsResource: (documentNumber: string, contract: ContractWrap, params?: RequestParams) => Promise<AxiosResponse<ContractWrap, any>>;
        /**
         * No description
         *
         * @tags ContractsResource
         ...
         */
        listContractsResource: (query?: {
            /** possibility to filter contracts */
            filter?: "active" | "inactive" | "finished";
        }, params?: RequestParams) => Promise<AxiosResponse<ContractListItemList, any>>;
        /**
         * No description
         *
         * @tags ContractsResource
         ...
         */
        createContractsResource: (contract: ContractWrap, params?: RequestParams) => Promise<AxiosResponse<ContractWrap, any>>;
        /**
         * No description
         *
         * @tags ContractsResource
         ...
         * @response `200` `ContractWrap` the updated contract
         */
        finish: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<ContractWrap, any>>;
        /**
         * No description
         *
         * @tags ContractsResource
         ...
         */
        createinvoice: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags ContractsResource
         ...
         * @response `200` `ContractWrap` the updated contract
         */
        increaseinvoicecount: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<ContractWrap, any>>;
    };
    contracttemplates: {
        /**
         ...
         */
        listContractTemplatesResource: (params?: RequestParams) => Promise<AxiosResponse<ContractTemplateListItemList, any>>;
        /**
         * No description
         *
         * @tags ContractTemplatesResource
         ...
         */
        createContractTemplatesResource: (contractTemplate: ContractTemplateWrap, params?: RequestParams) => Promise<AxiosResponse<ContractTemplateWrap, any>>;
        /**
         * No description
         *
         * @tags ContractTemplatesResource
         ...
         */
        getContractTemplatesResource: (templateNumber: number, params?: RequestParams) => Promise<AxiosResponse<ContractTemplateWrap, any>>;
        /**
         * No description
         *
         * @tags ContractTemplatesResource
         ...
         */
        updateContractTemplatesResource: (templateNumber: number, contractTemplate: ContractTemplateWrap, params?: RequestParams) => Promise<AxiosResponse<ContractTemplateWrap, any>>;
    };
    costcenters: {
        /**
         ...
         */
        listCostCentersResource: (params?: RequestParams) => Promise<AxiosResponse<CostCenterList, any>>;
        /**
         * No description
         *
         * @tags CostCentersResource
         ...
         */
        createCostCentersResource: (costCenter: CostCenterWrap, params?: RequestParams) => Promise<AxiosResponse<CostCenterWrap, any>>;
        /**
         * No description
         *
         * @tags CostCentersResource
         ...
         */
        getCostCentersResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<CostCenterWrap, any>>;
        /**
         * No description
         *
         * @tags CostCentersResource
         ...
         */
        updateCostCentersResource: (code: string, costCenter: CostCenterWrap, params?: RequestParams) => Promise<AxiosResponse<CostCenterWrap, any>>;
        /**
         * No description
         *
         * @tags CostCentersResource
         ...
         * @response `default` `void` empty
         */
        removeCostCentersResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    currencies: {
        /**
         ...
         */
        listCurrenciesResource: (params?: RequestParams) => Promise<AxiosResponse<CurrencyList, any>>;
        /**
         * No description
         *
         * @tags CurrenciesResource
         ...
         */
        createCurrenciesResource: (currency: CurrencyWrap, params?: RequestParams) => Promise<AxiosResponse<CurrencyWrap, any>>;
        /**
         * No description
         *
         * @tags CurrenciesResource
         ...
         */
        getCurrenciesResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<CurrencyWrap, any>>;
        /**
         * No description
         *
         * @tags CurrenciesResource
         ...
         */
        updateCurrenciesResource: (code: string, currency: CurrencyWrap, params?: RequestParams) => Promise<AxiosResponse<CurrencyWrap, any>>;
        /**
         * No description
         *
         * @tags CurrenciesResource
         ...
         */
        removeCurrenciesResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    customerreferences: {
        /**
         * @description </p>
         ...
         */
        listCustomerReferencesResource: (query?: {
            /** possibility to filter by customer number */
            customer?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<CustomerReferenceWrap, any>>;
        /**
         ...
         */
        createCustomerReferencesResource: (customerReferenceRow: CustomerReferenceCustomerReferenceRowWrap, params?: RequestParams) => Promise<AxiosResponse<CustomerReferenceWrap, any>>;
        /**
         ...
         */
        getCustomerReferencesResource: (customerReferenceRowId: string, params?: RequestParams) => Promise<AxiosResponse<CustomerReferenceWrap, any>>;
        /**
         ...
         */
        updateCustomerReferencesResource: (customerReferenceRowId: string, customerReferenceRow: CustomerReferenceCustomerReferenceRowWrap, params?: RequestParams) => Promise<AxiosResponse<CustomerWrap, any>>;
        /**
         ...
         * @response `default` `void` empty
         */
        removeCustomerReferencesResource: (customerReferenceRowId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    customers: {
        /**
         ...
         */
        createCustomersResource: (customer: CustomerWrap, params?: RequestParams) => Promise<AxiosResponse<CustomerWrap, any>>;
        /**
         ...
         */
        getCustomersResource: (customerNumber: string, params?: RequestParams) => Promise<AxiosResponse<CustomerWrap, any>>;
        /**
         ...
         */
        updateCustomersResource: (customerNumber: string, customer: CustomerWrap, params?: RequestParams) => Promise<AxiosResponse<CustomerWrap, any>>;
        /**
         ...
         * @response `default` `void` empty
         */
        removeCustomersResource: (customerNumber: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    employees: {
        /**
         ...
         */
        listEmployeesResource: (params?: RequestParams) => Promise<AxiosResponse<EmployeeListItemWrap, any>>;
        /**
         ...
         */
        createEmployeesResource: (employee: EmployeeWrap, params?: RequestParams) => Promise<AxiosResponse<EmployeeWrap, any>>;
        /**
         * @description ScheduleId, MonthlySalary and HourlyPay reflect current values, all ScheduleIds are returned in DatedSchedules and all MonthlySalary and HourlyPay pairs are returned in DatedWages.
         *
         * @tags EmployeesResource
         ...
         */
        getEmployeesResource: (employeeId: string, params?: RequestParams) => Promise<AxiosResponse<EmployeeWrap, any>>;
        /**
         ...
         */
        updateEmployeesResource: (employeeId: string, employee: EmployeeWrap, params?: RequestParams) => Promise<AxiosResponse<EmployeeWrap, any>>;
    };
    euvatlimitregulation: {
         ...
         */
        getEuVatLimitRegulationResource: (query?: {
            /**
             * eu vat limit regulation for year, if not provided than this will be set to current year
             * @format int32
             */
            year?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<EUVatLimitRegulationWrap, any>>;
    };
    expenses: {
        /**
         ...
         */
        listExpensesResource: (params?: RequestParams) => Promise<AxiosResponse<ExpenseListItemWrap, any>>;
        /**
         * No description
         *
         * @tags ExpensesResource
         ...
         */
        createExpensesResource: (expense: ExpenseWrap, params?: RequestParams) => Promise<AxiosResponse<ExpenseWrap, any>>;
        /**
         ...
         */
        getExpensesResource: (expenseCode: string, params?: RequestParams) => Promise<AxiosResponse<ExpenseWrap, any>>;
    };
    noxfinansinvoices: {
        /**
         ...
         */
        createFinanceInvoicesResource: (payload: CreatePayloadWrap, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceResponseWrap` The current status of the invoice <i>Response parameters:</i> <p> <ul> <li>@url: the URL used to retrieve the invoice status</li> <li>BalanceIncludeFees: the current balance of the invoice, fees included (in SEK)</li> <li>BalanceIncludeFeesCurrency: the current balance of the invoice, fees included, in other currency (currently only SEK is available)</li> <li>CurrentCapitalBalance: capital amount balance (in SEK)</li> <li>CurrentCapitalBalanceCurrency: capital amount balance in other currency (currently only SEK is available)</li> <li>InvoiceDocumentURL: URL to PDF document for invoice</li> <li>InvoiceNumber: invoice number in Fortnox</li> <li>NextEvent: the next event for the invoice</li> <li>NextEventDate: the date when the next event for the invoice will occur</li> <li>OCRNumber: the OCR number of the invoice</li> <li>Service: the service used for the invoice (LEDGERBASE or REMINDER)</li> <li>ServiceName: the detailed service name used for the invoice (SERVICE_FULL, SERVICE_LIGHT or REMINDER_SERVICE, this field is omitted if the invoice is sent with the old Noxbox service)</li> <li>Status: the current status of the invoice</li> </ul> <i>status</i> can be one of the following: <ul> <li>UNKNOWN: Not yet confirmed by Fortnox Finans</li> <li>NOT_AUTHORIZED: Factoring invoice waiting approval</li> <li>OPEN: invoice is open, and not fully paid yet</li> <li>PAUSED: invoice is paused</li> <li>CLOSED: invoice is closed (fully paid, credited or cancelled)</li> </ul>
         */
        getFinanceInvoicesResource: (number: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
        /**
         ...
         */
        stop: (number: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceResponseWrap` The current status of the invoice <i>Response parameters:</i> <p> <ul> <li>@url: the URL used to retrieve the invoice status</li> <li>BalanceIncludeFees: the current balance of the invoice, fees included (in SEK)</li> <li>BalanceIncludeFeesCurrency: the current balance of the invoice, fees included, in other currency (currently only SEK is available)</li> <li>CurrentCapitalBalance: capital amount balance (in SEK)</li> <li>CurrentCapitalBalanceCurrency: capital amount balance in other currency (currently only SEK is available)</li> <li>InvoiceDocumentURL: URL to PDF document for invoice</li> <li>InvoiceNumber: invoice number in Fortnox</li> <li>NextEvent: the next event for the invoice</li> <li>NextEventDate: the date when the next event for the invoice will occur</li> <li>OCRNumber: the OCR number of the invoice</li> <li>Service: the service used for the invoice (LEDGERBASE or REMINDER)</li> <li>ServiceName: the detailed service name used for the invoice (SERVICE_FULL, SERVICE_LIGHT or REMINDER_SERVICE, this field is omitted if the invoice is sent with the old Noxbox service)</li> <li>Status: the current status of the invoice</li> </ul> <i>status</i> can be one of the following: <ul> <li>UNKNOWN: Not yet confirmed by Fortnox Finans</li> <li>NOT_AUTHORIZED: Factoring invoice waiting approval</li> <li>OPEN: invoice is open, and not fully paid yet</li> <li>PAUSED: invoice is paused</li> <li>CLOSED: invoice is closed (fully paid, credited or cancelled)</li> </ul>
         */
        pause: (number: string, payload: PausePayloadWrap, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceResponseWrap` The current status of the invoice <i>Response parameters:</i> <p> <ul> <li>@url: the URL used to retrieve the invoice status</li> <li>BalanceIncludeFees: the current balance of the invoice, fees included (in SEK)</li> <li>BalanceIncludeFeesCurrency: the current balance of the invoice, fees included, in other currency (currently only SEK is available)</li> <li>CurrentCapitalBalance: capital amount balance (in SEK)</li> <li>CurrentCapitalBalanceCurrency: capital amount balance in other currency (currently only SEK is available)</li> <li>InvoiceDocumentURL: URL to PDF document for invoice</li> <li>InvoiceNumber: invoice number in Fortnox</li> <li>NextEvent: the next event for the invoice</li> <li>NextEventDate: the date when the next event for the invoice will occur</li> <li>OCRNumber: the OCR number of the invoice</li> <li>Service: the service used for the invoice (LEDGERBASE or REMINDER)</li> <li>ServiceName: the detailed service name used for the invoice (SERVICE_FULL, SERVICE_LIGHT or REMINDER_SERVICE, this field is omitted if the invoice is sent with the old Noxbox service)</li> <li>Status: the current status of the invoice</li> </ul> <i>status</i> can be one of the following: <ul> <li>UNKNOWN: Not yet confirmed by Fortnox Finans</li> <li>NOT_AUTHORIZED: Factoring invoice waiting approval</li> <li>OPEN: invoice is open, and not fully paid yet</li> <li>PAUSED: invoice is paused</li> <li>CLOSED: invoice is closed (fully paid, credited or cancelled)</li> </ul>
         */
        unpause: (number: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceResponseWrap` The current status of the invoice <i>Response parameters:</i> <p> <ul> <li>@url: the URL used to retrieve the invoice status</li> <li>BalanceIncludeFees: the current balance of the invoice, fees included (in SEK)</li> <li>BalanceIncludeFeesCurrency: the current balance of the invoice, fees included, in other currency (currently only SEK is available)</li> <li>CurrentCapitalBalance: capital amount balance (in SEK)</li> <li>CurrentCapitalBalanceCurrency: capital amount balance in other currency (currently only SEK is available)</li> <li>InvoiceDocumentURL: URL to PDF document for invoice</li> <li>InvoiceNumber: invoice number in Fortnox</li> <li>NextEvent: the next event for the invoice</li> <li>NextEventDate: the date when the next event for the invoice will occur</li> <li>OCRNumber: the OCR number of the invoice</li> <li>Service: the service used for the invoice (LEDGERBASE or REMINDER)</li> <li>ServiceName: the detailed service name used for the invoice (SERVICE_FULL, SERVICE_LIGHT or REMINDER_SERVICE, this field is omitted if the invoice is sent with the old Noxbox service)</li> <li>Status: the current status of the invoice</li> </ul> <i>status</i> can be one of the following: <ul> <li>UNKNOWN: Not yet confirmed by Fortnox Finans</li> <li>NOT_AUTHORIZED: Factoring invoice waiting approval</li> <li>OPEN: invoice is open, and not fully paid yet</li> <li>PAUSED: invoice is paused</li> <li>CLOSED: invoice is closed (fully paid, credited or cancelled)</li> </ul>
         */
        takeFees: (number: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceResponseWrap` The current status of the invoice <i>Response parameters:</i> <p> <ul> <li>@url: the URL used to retrieve the invoice status</li> <li>BalanceIncludeFees: the current balance of the invoice, fees included (in SEK)</li> <li>BalanceIncludeFeesCurrency: the current balance of the invoice, fees included, in other currency (currently only SEK is available)</li> <li>CurrentCapitalBalance: capital amount balance (in SEK)</li> <li>CurrentCapitalBalanceCurrency: capital amount balance in other currency (currently only SEK is available)</li> <li>InvoiceDocumentURL: URL to PDF document for invoice</li> <li>InvoiceNumber: invoice number in Fortnox</li> <li>NextEvent: the next event for the invoice</li> <li>NextEventDate: the date when the next event for the invoice will occur</li> <li>OCRNumber: the OCR number of the invoice</li> <li>Service: the service used for the invoice (LEDGERBASE or REMINDER)</li> <li>ServiceName: the detailed service name used for the invoice (SERVICE_FULL, SERVICE_LIGHT or REMINDER_SERVICE, this field is omitted if the invoice is sent with the old Noxbox service)</li> <li>Status: the current status of the invoice</li> </ul> <i>status</i> can be one of the following: <ul> <li>UNKNOWN: Not yet confirmed by Fortnox Finans</li> <li>NOT_AUTHORIZED: Factoring invoice waiting approval</li> <li>OPEN: invoice is open, and not fully paid yet</li> <li>PAUSED: invoice is paused</li> <li>CLOSED: invoice is closed (fully paid, credited or cancelled)</li> </ul>
         */
        reportPayment: (number: string, payload: ReportPaymentPayload, params?: RequestParams) => Promise<AxiosResponse<InvoiceResponseWrap, any>>;
    };
    financialyears: {
        /**
        ...
        getByDate: (query?: {
             ...
             */
            Date?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<FinancialYearWrapList, any>>;
        /**
         * No description
         *
         * @tags FinancialYearsResource
         ...
         */
        createFinancialYearsResource: (financialYear: FinancialYearWrap, params?: RequestParams) => Promise<AxiosResponse<FinancialYearWrap, any>>;
        /**
         * No description
         *
         * @tags FinancialYearsResource
         ...
         */
        getById: (id: number, params?: RequestParams) => Promise<AxiosResponse<FinancialYearWrap, any>>;
    };
    inbox: {
        /**
         * No description
         ...
         */
        getInboxResource: (params?: RequestParams) => Promise<AxiosResponse<FolderWrap, any>>;
        /**
         ...
         * @response `200` `string` a single file
         */
        getFileByIdInboxResource: (id: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         * No description
         *
         * @tags InboxResource
         ...
         * @response `default` `void` empty
         */
        removeInboxResource: (id: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    invoiceaccruals: {
        /**
         ...
         */
        listInvoiceAccrualsResource: (params?: RequestParams) => Promise<AxiosResponse<InvoiceAccrualListItemList, any>>;
        /**
         * No description
         *
         * @tags InvoiceAccrualsResource
         ...
         */
        createInvoiceAccrualsResource: (invoiceAccrual: InvoiceAccrualWrap, params?: RequestParams) => Promise<AxiosResponse<InvoiceAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags InvoiceAccrualsResource
         ...
         */
        getInvoiceAccrualsResource: (invoiceNumber: number, params?: RequestParams) => Promise<AxiosResponse<InvoiceAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags InvoiceAccrualsResource
         ...
         */
        updateInvoiceAccrualsResource: (invoiceNumber: number, invoiceAccrual: InvoiceAccrualWrap, params?: RequestParams) => Promise<AxiosResponse<InvoiceAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags InvoiceAccrualsResource
         ...
         * @response `default` `void` empty
         */
        removeInvoiceAccrualsResource: (invoiceNumber: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    invoicepayments: {
        /**
         * No description
         ...
         */
        listInvoicePaymentsResource: (query?: {
            /**
            ...
            /** field to sort returned list on */
            sortby?: "paymentdate";
        }, params?: RequestParams) => Promise<AxiosResponse<InvoicePaymentListItemList, any>>;
        /**
         * No description
         *
         * @tags InvoicePaymentsResource
         ...
         */
        createInvoicePaymentsResource: (invoicePayment: InvoicePaymentWrap, params?: RequestParams) => Promise<AxiosResponse<InvoicePaymentWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicePaymentsResource
         ...
         */
        getInvoicePaymentsResource: (number: string, params?: RequestParams) => Promise<AxiosResponse<InvoicePaymentWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicePaymentsResource
         ...
         */
        updateInvoicePaymentsResource: (number: string, invoicePayment: InvoicePaymentWrap, params?: RequestParams) => Promise<AxiosResponse<InvoicePaymentWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicePaymentsResource
         ...
         * @response `default` `void` empty
         */
        removeInvoicePaymentsResource: (number: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags InvoicePaymentsResource
         ...
         * @response `200` `InvoicePaymentWrap` the updated invoice payment
         */
        bookkeep: (number: string, invoicePayment: InvoicePaymentWrap, params?: RequestParams) => Promise<AxiosResponse<InvoicePaymentWrap, any>>;
    };
    invoices: {
        /**
         * No description
         ...
         */
        getInvoicesResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         ...
         */
        updateInvoicesResource: (documentNumber: string, invoicePayload: InvoicePayloadWrap, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicesResource
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<InvoiceListItemWrap, any>>;
        /**
         ...
         */
        createInvoicesResource: (invoicePayload: InvoicePayloadWrap, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicesResource
         ...
         * @response `200` `InvoiceWrap` the updated invoice
         */
        bookkeepInvoicesResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicesResource
         ...
         * @response `200` `InvoiceWrap` the updated invoice
         */
        cancel: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceWrap` the updated invoice
         */
        credit: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceWrap` the updated invoice
         */
        externalPrint: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         ...
         * @response `200` `InvoiceWrap` the updated invoice
         */
        warehouseReady: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicesResource
         ...
         */
        print: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         ...
         */
        email: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicesResource
         ...
         * @response `200` `string` the invoice as PDF
         */
        printReminder: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         ...
         * @response `200` `InvoiceWrap` sent invoice
         */
        ePrint: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags InvoicesResource
         ...
         * @response `200` `InvoiceWrap` sent invoice
         */
        eInvoice: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
    };
    labels: {
        /**
         * No description
         ...
         */
        listLabelsResource: (params?: RequestParams) => Promise<AxiosResponse<LabelList, any>>;
        /**
         ...
         */
        createLabelsResource: (label: LabelWrap, params?: RequestParams) => Promise<AxiosResponse<LabelWrap, any>>;
        /**
         ...
         */
        updateLabelsResource: (id: number, label: LabelWrap, params?: RequestParams) => Promise<AxiosResponse<LabelWrap, any>>;
        /**
         ...
         * @response `default` `void` empty
         */
        removeLabelsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    me: {
        /**
     * No description
     ...
     */
        getMeResource: (params?: RequestParams) => Promise<AxiosResponse<MeWrap, any>>;
    };
    modesofpayments: {
        /**
         ...
         */
        listModesOfPaymentsResource: (params?: RequestParams) => Promise<AxiosResponse<ModeOfPaymentList, any>>;
        /**
         * No description
         *
         * @tags ModesOfPaymentsResource
         ...
         */
        createModesOfPaymentsResource: (modeOfPayment: ModeOfPaymentWrap, params?: RequestParams) => Promise<AxiosResponse<ModeOfPaymentWrap, any>>;
        /**
         * No description
         *
         * @tags ModesOfPaymentsResource
         ...
         */
        getModesOfPaymentsResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<ModeOfPaymentWrap, any>>;
        /**
         * No description
         *
         * @tags ModesOfPaymentsResource
         ...
         */
        updateModesOfPaymentsResource: (code: string, unit: ModeOfPaymentWrap, params?: RequestParams) => Promise<AxiosResponse<ModeOfPaymentWrap, any>>;
    };
    offers: {
        /**
         * No description
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<OfferListItemList, any>>;
        /**
         ...
         */
        createOffersResource: (offer: OfferWrap, params?: RequestParams) => Promise<AxiosResponse<OfferWrap, any>>;
        /**
         * No description
         *
         * @tags OffersResource
         ...
         */
        getOffersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OfferWrap, any>>;
        /**
         ...
         */
        updateOffersResource: (documentNumber: string, offer: OfferWrap, params?: RequestParams) => Promise<AxiosResponse<OfferWrap, any>>;
        /**
         * No description
         *
         * @tags OffersResource
         ...
         */
        printOffersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         ...
         * @response `200` `OfferWrap` the existing offer
         */
        emailOffersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OfferWrap, any>>;
        /**
         * @description The difference between this and the print-endpoint is that property Sent is not set to TRUE.
         *
         * @tags OffersResource
         ...
         * @response `200` `string` the existing offer
         */
        previewOffersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         * No description
         *
         * @tags OffersResource
         ...
         */
        createorder: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         * No description
         *
         * @tags OffersResource
         ...
         */
        createinvoiceOffersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         * No description
         *
         * @tags OffersResource
         ...
         * @response `200` `OfferWrap` the updated offer
         */
        cancelOffersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OfferWrap, any>>;
        /**
         ...
         * @response `200` `OfferWrap` the updated offer
         */
        externalprint: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OfferWrap, any>>;
    };
    orders: {
        /**
         * No description
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<OrderListItemList, any>>;
        /**
         ...
         * @response `200` `OrderWrap` the created order
         */
        createOrdersResource: (order: OrderWrap, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         * No description
         *
         * @tags OrdersResource
         ...
         */
        getOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         ...
         */
        updateOrdersResource: (documentNumber: string, order: OrderWrap, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         * No description
         *
         * @tags OrdersResource
         ...
         */
        printOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         ...
         * @response `200` `OrderWrap` the existing order
         */
        emailOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         * @description The difference between this and the print-endpoint is that property Sent is not set to TRUE.
         *
         * @tags OrdersResource
         ...
         * @response `200` `string` the given order as PDF
         */
        previewOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<string, any>>;
        /**
         * No description
         *
         * @tags OrdersResource
         ...
         * @response `200` `InvoiceWrap` the created invoice
         */
        createinvoiceOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<InvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags OrdersResource
         ...
         * @response `200` `OrderWrap` the updated order
         */
        cancelOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
        /**
         ...
         * @response `200` `OrderWrap` the updated order
         */
        externalprintOrdersResource: (documentNumber: string, params?: RequestParams) => Promise<AxiosResponse<OrderWrap, any>>;
    };
    predefinedaccounts: {
        /**
         * No description
         ...
         */
        listPredefinedAccountsResource: (params?: RequestParams) => Promise<AxiosResponse<PredefinedAccountList, any>>;
        /**
         * No description
         *
         * @tags PredefinedAccountsResource
         ...
         */
        getPredefinedAccountsResource: (name: string, params?: RequestParams) => Promise<AxiosResponse<PredefinedAccountWrap, any>>;
        /**
         ...
         */
        updatePredefinedAccountsResource: (name: string, predefinedAccount: PredefinedAccountWrap, params?: RequestParams) => Promise<AxiosResponse<PredefinedAccountWrap, any>>;
    };
    predefinedvoucherseries: {
         ...
         */
        listPredefinedVoucherSeriesResource: (params?: RequestParams) => Promise<AxiosResponse<PredefinedVoucherSeriesList, any>>;
        /**
         * No description
         *
         * @tags PredefinedVoucherSeriesResource
         ...
         */
        getPredefinedVoucherSeriesResource: (name: string, params?: RequestParams) => Promise<AxiosResponse<PredefinedVoucherSeriesWrap, any>>;
        /**
         * No description
         *
         * @tags PredefinedVoucherSeriesResource
         ...
         */
        updatePredefinedVoucherSeriesResource: (name: string, predefinedVoucherSeries: PredefinedVoucherSeriesWrap, params?: RequestParams) => Promise<AxiosResponse<PredefinedVoucherSeriesWrap, any>>;
    };
    pricelists: {
        /**
         ...
         */
        listPriceListsResource: (params?: RequestParams) => Promise<AxiosResponse<PriceListList, any>>;
        /**
         * No description
         *
         * @tags PriceListsResource
         ...
         */
        createPriceListsResource: (priceList: PriceListWrap, params?: RequestParams) => Promise<AxiosResponse<PriceListWrap, any>>;
        /**
         * No description
         *
         * @tags PriceListsResource
         ...
         */
        getPriceListsResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<PriceListWrap, any>>;
        /**
         * No description
         *
         * @tags PriceListsResource
         ...
         */
        updatePriceListsResource: (code: string, priceList: PriceListWrap, params?: RequestParams) => Promise<AxiosResponse<PriceListWrap, any>>;
    };
    prices: {
        /**
         * No description
         ...
         */
        getPricesResource: (priceList: string, articleNumber: string, fromQuantity: number, params?: RequestParams) => Promise<AxiosResponse<PriceWrap, any>>;
        /**
         * No description
         *
         * @tags PricesResource
         ...
         */
        updatePricesResource: (priceList: string, articleNumber: string, fromQuantity: number, price: PriceWrap, params?: RequestParams) => Promise<AxiosResponse<PriceWrap, any>>;
        /**
         * No description
         *
         * @tags PricesResource
         ...
         * @response `default` `void` empty
         */
        removePricesResource: (priceList: string, articleNumber: string, fromQuantity: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        listPricesResource: (priceList: string, articleNumber: string, params?: RequestParams) => Promise<AxiosResponse<PriceListItemList, any>>;
        /**
         * No description
         *
         * @tags PricesResource
         ...
         */
        getFirstPrice: (priceList: string, articleNumber: string, params?: RequestParams) => Promise<AxiosResponse<PriceWrap, any>>;
        /**
         * No description
         *
         * @tags PricesResource
         ...
         * @response `200` `PriceWrap` the updated price
         */
        updatePricesResource1: (priceList: string, articleNumber: string, price: PriceWrap, params?: RequestParams) => Promise<AxiosResponse<PriceWrap, any>>;
        /**
         * No description
         *
         * @tags PricesResource
         ...
         */
        createPricesResource: (price: PriceWrap, params?: RequestParams) => Promise<AxiosResponse<PriceWrap, any>>;
    };
    printtemplates: {
        /**
         * No description
         ...
         */
        listPrintTemplatesResource: (params?: RequestParams) => Promise<AxiosResponse<PrintTemplateList, any>>;
    };
    projects: {
        /**
         * No description
         ...
         */
        getProjectsResource: (projectNumber: number, params?: RequestParams) => Promise<AxiosResponse<ProjectWrap, any>>;
        /**
         * No description
         *
         * @tags ProjectsResource
         ...
         */
        updateProjectsResource: (projectNumber: number, project: ProjectWrap, params?: RequestParams) => Promise<AxiosResponse<ProjectWrap, any>>;
        /**
         * No description
         *
         * @tags ProjectsResource
         ...
         * @response `default` `void` empty
         */
        removeProjectsResource: (projectNumber: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         ...
         */
        listProjectsResource: (params?: RequestParams) => Promise<AxiosResponse<ProjectListItemList, any>>;
        /**
         * No description
         *
         * @tags ProjectsResource
         ...
         */
        createProjectsResource: (project: ProjectWrap, params?: RequestParams) => Promise<AxiosResponse<ProjectWrap, any>>;
    };
    salarytransactions: {
        /**
         ...
         */
        listSalaryTransactionsResource: (query?: {
             ...
             */
            date?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<SalaryTransactionListItemList, any>>;
        /**
         * No description
         *
         * @tags SalaryTransactionsResource
         ...
         */
        createSalaryTransactionsResource: (salaryTransaction: SalaryTransactionWrap, params?: RequestParams) => Promise<AxiosResponse<SalaryTransactionWrap, any>>;
        /**
         * No description
         *
         * @tags SalaryTransactionsResource
         ...
         */
        getSalaryTransactionsResource: (salaryRow: number, params?: RequestParams) => Promise<AxiosResponse<SalaryTransactionWrap, any>>;
        /**
         * No description
         *
         * @tags SalaryTransactionsResource
         ...
         */
        updateSalaryTransactionsResource: (salaryRow: number, salaryTransaction: SalaryTransactionWrap, params?: RequestParams) => Promise<AxiosResponse<SalaryTransactionWrap, any>>;
        /**
         * No description
         *
         * @tags SalaryTransactionsResource
         ...
         * @response `200` `SalaryTransactionWrap` the existing salary transaction
         */
        deleteSalaryTransactionsResource: (salaryRow: number, params?: RequestParams) => Promise<AxiosResponse<SalaryTransactionWrap, any>>;
    };
    scheduletimes: {
        /**
         * No description
         ...
         */
        getScheduleTimesResource: (employeeId: string, date: string, params?: RequestParams) => Promise<AxiosResponse<ScheduleTimeWrap, any>>;
        /**
         * No description
         *
         * @tags ScheduleTimesResource
         ...
         */
        updateScheduleTimesResource: (employeeId: string, date: string, scheduleTime: ScheduleTimeWrap, params?: RequestParams) => Promise<AxiosResponse<ScheduleTimeWrap, any>>;
        /**
         * No description
         *
         * @tags ScheduleTimesResource
         ...
         */
        reset: (employeeId: string, date: string, params?: RequestParams) => Promise<AxiosResponse<ScheduleTimeWrap, any>>;
    };
    sie: {
        /**
         ...
         */
        getSieResource: (type: string, query?: {
            /**
             * financialYear
             * @format int32
             */
    ...
    supplierinvoiceaccruals: {
         ...
         */
        listSupplierInvoiceAccrualsResource: (params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceAccrualListItemList, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceAccrualsResource
         ...
         */
        createSupplierInvoiceAccrualsResource: (supplierInvoiceAccrual: SupplierInvoiceAccrualWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceAccrualsResource
         ...
         */
        getSupplierInvoiceAccrualsResource: (supplierInvoiceNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceAccrualsResource
         ...
         */
        updateSupplierInvoiceAccrualsResource: (supplierInvoiceNumber: number, supplierInvoiceAccrual: SupplierInvoiceAccrualWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceAccrualWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceAccrualsResource
         ...
         * @response `default` `void` empty
         */
        removeSupplierInvoiceAccrualsResource: (supplierInvoiceNumber: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    supplierinvoiceexternalurlconnections: {
         ...
         */
        getSupplierInvoiceExternalUrlConnectionsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceExternalURLConnectionSingle, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceExternalUrlConnectionsResource
         ...
         * @response `200` `SupplierInvoiceExternalURLConnectionSingle` supplier invoice external url connection
         */
        updateSupplierInvoiceExternalUrlConnectionsResource: (id: number, request: SupplierInvoiceExternalURLConnectionUpdate, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceExternalURLConnectionSingle, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceExternalUrlConnectionsResource
         ...
         * @response `default` `void` empty
         */
        deleteSupplierInvoiceExternalUrlConnectionsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceExternalUrlConnectionsResource
         ...
         * @response `200` `SupplierInvoiceExternalURLConnectionSingle` supplier invoice external url connection
         */
        createSupplierInvoiceExternalUrlConnectionsResource: (request: SupplierInvoiceExternalURLConnectionUpdate, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceExternalURLConnectionSingle, any>>;
    };
    supplierinvoicefileconnections: {
         ...
         */
        listSupplierInvoiceFileConnectionsResource: (params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceFileConnectionList, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceFileConnectionsResource
         ...
         */
        createSupplierInvoiceFileConnectionsResource: (fileConnection: SupplierInvoiceFileConnectionWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceFileConnectionWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceFileConnectionsResource
         ...
         */
        getSupplierInvoiceFileConnectionsResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceFileConnectionWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoiceFileConnectionsResource
         ...
         * @response `default` `void` empty
         */
        removeSupplierInvoiceFileConnectionsResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    supplierinvoicepayments: {
         ...
         */
        listSupplierInvoicePaymentsResource: (params?: RequestParams) => Promise<AxiosResponse<SupplierInvoicePaymentListItemList, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicePaymentsResource
         ...
         */
        createSupplierInvoicePaymentsResource: (supplierInvoicePayment: SupplierInvoicePaymentWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoicePaymentWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicePaymentsResource
         ...
         */
        getSupplierInvoicePaymentsResource: (number: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoicePaymentWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicePaymentsResource
         ...
         */
        updateSupplierInvoicePaymentsResource: (number: number, supplierInvoicePayment: SupplierInvoicePaymentWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoicePaymentWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicePaymentsResource
         ...
         * @response `default` `void` empty
         */
        removeSupplierInvoicePaymentsResource: (number: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicePaymentsResource
         ...
         * @response `200` `SupplierInvoicePaymentWrap` the updated supplier invoice payment
         */
        bookkeepSupplierInvoicePaymentsResource: (number: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoicePaymentWrap, any>>;
    };
    supplierinvoices: {
        /**
         * No description
         ...
         */
        listSupplierInvoicesResource: (query?: {
            /** possibility to filter supplier invoices */
            filter?: "cancelled" | "fullypaid" | "unpaid" | "unpaidoverdue" | "unbooked" | "pendingpayment" | "authorizepending";
        }, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceListItemWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         */
        createSupplierInvoicesResource: (supplierInvoice: SupplierInvoiceWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         */
        getSupplierInvoicesResource: (givenNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         */
        updateSupplierInvoicesResource: (givenNumber: number, supplierInvoice: SupplierInvoiceWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         * @response `200` `SupplierInvoiceWrap` the updated supplier invoice
         */
        bookkeepSupplierInvoicesResource: (givenNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         * @response `200` `SupplierInvoiceWrap` the updated supplier invoice
         */
        cancelSupplierInvoicesResource: (givenNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         ...
         * @response `200` `SupplierInvoiceWrap` the updated supplier invoice
         */
        creditSupplierInvoicesResource: (givenNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         * @response `200` `SupplierInvoiceWrap` the updated supplier invoice
         */
        approvalpayment: (givenNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
        /**
         * No description
         *
         * @tags SupplierInvoicesResource
         ...
         * @response `200` `SupplierInvoiceWrap` the updated supplier invoice
         */
        approvalbookkeep: (givenNumber: number, params?: RequestParams) => Promise<AxiosResponse<SupplierInvoiceWrap, any>>;
    };
    suppliers: {
        /**
         ...
         */
        listSuppliersResource: (params?: RequestParams) => Promise<AxiosResponse<SupplierListItemList, any>>;
        /**
         * No description
         *
         * @tags SuppliersResource
         ...
         */
        createSuppliersResource: (supplier: SupplierWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierWrap, any>>;
        /**
         * No description
         *
         * @tags SuppliersResource
         ...
         */
        getSuppliersResource: (supplierNumber: string, params?: RequestParams) => Promise<AxiosResponse<SupplierWrap, any>>;
        /**
         * No description
         *
         * @tags SuppliersResource
         ...
         */
        updateSuppliersResource: (supplierNumber: string, supplier: SupplierWrap, params?: RequestParams) => Promise<AxiosResponse<SupplierWrap, any>>;
    };
    taxreductions: {
        /**
         * No description
         ...
         */
        listTaxReductionsResource: (query?: {
            /** possibility to filter tax reductions */
            filter?: "invoices" | "orders" | "offers";
        }, params?: RequestParams) => Promise<AxiosResponse<TaxReductionListItemList, any>>;
        /**
         ...
         */
        createTaxReductionsResource: (taxReduction: TaxReductionWrap, params?: RequestParams) => Promise<AxiosResponse<TaxReductionWrap, any>>;
        /**
         * No description
         *
         * @tags TaxReductionsResource
         ...
         */
        getTaxReductionsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<TaxReductionWrap, any>>;
        /**
         * No description
         *
         * @tags TaxReductionsResource
         ...
         */
        updateTaxReductionsResource: (id: number, taxReduction: TaxReductionWrap, params?: RequestParams) => Promise<AxiosResponse<TaxReductionWrap, any>>;
        /**
         * No description
         *
         * @tags TaxReductionsResource
         ...
         * @response `default` `void` empty
         */
        removeTaxReductionsResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    termsofdeliveries: {
        /**
         ...
         */
        listTermsOfDeliveriesResource: (params?: RequestParams) => Promise<AxiosResponse<TermsOfDeliveryList, any>>;
        /**
         * No description
         *
         * @tags TermsOfDeliveriesResource
         ...
         */
        createTermsOfDeliveriesResource: (termOfDelivery: TermsOfDeliveryWrap, params?: RequestParams) => Promise<AxiosResponse<TermsOfDeliveryWrap, any>>;
        /**
         * No description
         *
         * @tags TermsOfDeliveriesResource
         ...
         */
        getTermsOfDeliveriesResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<TermsOfDeliveryWrap, any>>;
        /**
         * No description
         *
         * @tags TermsOfDeliveriesResource
         ...
         */
        updateTermsOfDeliveriesResource: (code: string, termsOfDelivery: TermsOfDeliveryWrap, params?: RequestParams) => Promise<AxiosResponse<TermsOfDeliveryWrap, any>>;
    };
    termsofpayments: {
        /**
         * No description
         ...
         */
        listTermsOfPaymentsResource: (params?: RequestParams) => Promise<AxiosResponse<TermsOfPaymentList, any>>;
        /**
         * No description
         *
         * @tags TermsOfPaymentsResource
         ...
         */
        createTermsOfPaymentsResource: (termsOfPayment: TermsOfPaymentWrap, params?: RequestParams) => Promise<AxiosResponse<TermsOfPaymentWrap, any>>;
        /**
         * No description
         *
         * @tags TermsOfPaymentsResource
         ...
         */
        getTermsOfPaymentsResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<TermsOfPaymentWrap, any>>;
        /**
         * No description
         *
         * @tags TermsOfPaymentsResource
         ...
         */
        updateTermsOfPaymentsResource: (code: string, termOfPayment: TermsOfPaymentWrap, params?: RequestParams) => Promise<AxiosResponse<TermsOfPaymentWrap, any>>;
        /**
         * No description
         *
         * @tags TermsOfPaymentsResource
         ...
         * @response `default` `void` empty
         */
        removeTermsOfPaymentsResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    emailsenders: {
        /**
         * No description
         ...
         */
        getTrustedEmailSendersResource: (params?: RequestParams) => Promise<AxiosResponse<TrustedEmailSenderWrap, any>>;
        /**
         * No description
         *
         * @tags TrustedEmailSendersResource
         ...
         */
        createTrustedEmailSendersResource: (trustedEmailSender: TrustedEmailSenderTrustedSenderWrap, params?: RequestParams) => Promise<AxiosResponse<TrustedEmailSenderTrustedSenderWrap, any>>;
        /**
         ...
         * @response `default` `void` empty
         */
        removeTrustedEmailSendersResource: (id: number, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    units: {
        /**
         ...
         */
        listUnitsResource: (params?: RequestParams) => Promise<AxiosResponse<UnitList, any>>;
        /**
         * No description
         *
         * @tags UnitsResource
         ...
         */
        createUnitsResource: (unit: UnitWrap, params?: RequestParams) => Promise<AxiosResponse<UnitWrap, any>>;
        /**
         * No description
         *
         * @tags UnitsResource
         ...
         */
        getUnitsResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<UnitWrap, any>>;
        /**
         * No description
         *
         * @tags UnitsResource
         ...
         */
        updateUnitsResource: (code: string, unit: UnitWrap, params?: RequestParams) => Promise<AxiosResponse<UnitWrap, any>>;
        /**
         * No description
         *
         * @tags UnitsResource
         ...
         * @response `default` `void` empty
         */
        removeUnitsResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    vacationdebtbasis: {
        /**
         * No description
         ...
         */
        getVacationDebtBasisResource: (year: number, month: number, params?: RequestParams) => Promise<AxiosResponse<VacationDebtBasisWrap, any>>;
    };
    voucherfileconnections: {
         ...
         */
        listVoucherFileConnectionsResource: (params?: RequestParams) => Promise<AxiosResponse<VoucherFileConnectionList, any>>;
        /**
         * No description
         *
         * @tags VoucherFileConnectionsResource
         ...
         */
        createVoucherFileConnectionsResource: (voucherFileConnection: VoucherFileConnectionWrap, params?: RequestParams) => Promise<AxiosResponse<VoucherFileConnectionWrap, any>>;
        /**
         * No description
         *
         * @tags VoucherFileConnectionsResource
         ...
         */
        getVoucherFileConnectionsResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<VoucherFileConnectionWrap, any>>;
        /**
         * No description
         *
         * @tags VoucherFileConnectionsResource
         ...
         * @response `default` `void` empty
         */
        removeVoucherFileConnectionsResource: (fileId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    vouchers: {
        /**
         * No description
         ...
         */
        getVouchersResource: (voucherSeries: string, voucherNumber: number, query?: {
            /**
             * filter on financial year
             * @format int32
             */
            financialyear?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<VoucherWrap, any>>;
        /**
         ...
         */
        listVouchersResource: (query?: {
            /**
             * filter on financial year
             * @format int32
             */
            financialyear?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<VoucherListItemList, any>>;
        /**
         ...
         */
        createVouchersResource: (voucher: VoucherWrap, query?: {
            /**
         ...
         * @response `200` `VoucherListItemList` list of vouchers
         */
        listSeries: (voucherSeries: string, query?: {
            /**
             * filter on financial year
             * @format int32
             */
    ...
    voucherseries: {
         ...
         */
        listVoucherSeriesResource: (params?: RequestParams) => Promise<AxiosResponse<VoucherSeriesListItemList, any>>;
        /**
         * No description
         *
         * @tags VoucherSeriesResource
         ...
         */
        createVoucherSeriesResource: (voucherSeries: VoucherSeriesWrap, params?: RequestParams) => Promise<AxiosResponse<VoucherSeriesWrap, any>>;
        /**
         * No description
         *
         * @tags VoucherSeriesResource
         ...
         */
        getVoucherSeriesResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<VoucherSeriesWrap, any>>;
        /**
         * No description
         *
         * @tags VoucherSeriesResource
         ...
         */
        updateVoucherSeriesResource: (code: string, voucherSeries: VoucherSeriesWrap, params?: RequestParams) => Promise<AxiosResponse<VoucherSeriesWrap, any>>;
    };
    wayofdeliveries: {
        /**
         ...
         */
        listWayOfDeliveriesResource: (params?: RequestParams) => Promise<AxiosResponse<WayOfDeliveryList, any>>;
        /**
         * No description
         *
         * @tags WayOfDeliveriesResource
         ...
         */
        createWayOfDeliveriesResource: (wayOfDelivery: WayOfDeliveryWrap, params?: RequestParams) => Promise<AxiosResponse<WayOfDeliveryWrap, any>>;
        /**
         * No description
         *
         * @tags WayOfDeliveriesResource
         ...
         */
        getWayOfDeliveriesResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<WayOfDeliveryWrap, any>>;
        /**
         * No description
         *
         * @tags WayOfDeliveriesResource
         ...
         */
        updateWayOfDeliveriesResource: (code: string, wayOfDelivery: WayOfDeliveryWrap, params?: RequestParams) => Promise<AxiosResponse<WayOfDeliveryWrap, any>>;
        /**
         * No description
         *
         * @tags WayOfDeliveriesResource
         ...
         * @response `default` `void` empty
         */
        removeWayOfDeliveriesResource: (code: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
    fileattachments: {
        /**
         * No description
        ...
        getAttachments: (query: {
            ...
            entitytype: "OF" | "O" | "F" | "C" | "LGR_IO" | "LGR_IG";
        }, params?: RequestParams) => Promise<AxiosResponse<Attachment[], any>>;
        /**
         * No description
         *
         * @tags AttachmentResource
         ...
         * @response `200` `(Attachment)[]` A list of attachments
         */
        attach: (attachments: Attachment[], params?: RequestParams) => Promise<AxiosResponse<Attachment[], any>>;
        /**
         * No description
         *
         * @tags AttachmentResource
         ...
         * @response `default` `void` nothing
         */
        validateIncludedOnSend: (attachments: Attachment[], params?: RequestParams) => Promise<AxiosResponse<any, any>>;
        /**
         * No description
         *
         * @tags AttachmentResource
         ...
         */
        updateAttachment: (attachmentId: string, attachment: Attachment, params?: RequestParams) => Promise<AxiosResponse<Attachment, any>>;
        /**
         * No description
         *
         * @tags AttachmentResource
         ...
         */
        detach: (attachmentId: string, params?: RequestParams) => Promise<AxiosResponse<any, any>>;
    };
}
