...
var FileBuffer = /** @class */ (function () {
    function FileBuffer(buffer, fileName, contentType) {
    ...
    FileBuffer.prototype.slice = function () {
        throw new Error('FileBuffer.slice not implemented');
    };
    FileBuffer.prototype.stream = function () {
        throw new Error('FileBuffer.stream not implemented');
    };
    FileBuffer.prototype.text = function () {
        throw new Error('FileBuffer.text not implemented');
    };
    FileBuffer.prototype.arrayBuffer = function () {
